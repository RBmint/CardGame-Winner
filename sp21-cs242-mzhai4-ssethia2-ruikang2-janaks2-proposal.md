...
|-----------|:---------:|-------------------------------------------------------------------------------|
| Player class | 5 | 0: Didn't implement anything <br> 3: Implemented all necessary fields and constructor <br> 5: Implemented all necessary getters and helper functions|
| Co-implementing Game class | 5 | 0: Didn't implement anything <br> 3: Implemented all necessary fields and constructor <br> 5: Implemented all necessary getters and helper functions |
...
| Category | Total Score Allocated | Detailed Rubrics |
|-----------|:---------:|-------------------------------------------------------------------------------|
| Card class | 5 | 0: Didn't implement anything <br> 3: Implemented all necessary fields and constructor <br> 5: Implemented all necessary getters and helper functions|
| Co-implementing Game class | 5 | 0: Didn't implement anything <br> 3: Implemented all necessary fields and constructor <br> 5: Implemented all necessary getters and helper functions |
| Coding style | 5 | 0: Didn't implement any documentation <br>3: Implemented some documentation but not all of them <br> 5: All classes and functions have documentations and codes are properly formatted according to java-style |
...
| Category | Total Score Allocated | Detailed Rubrics |
|-----------|:---------:|-------------------------------------------------------------------------------|
| Game loop: joinable by players | 6 | 0: Didn't implement anything <br> 2: Implemented a loop <br> 4: Allow player to enter the game loop but not fully functional <br> 7: Fully functioning multi-player game loop that allows a input number of players and switches turns properly |
| Game loop: start and end | 6 | 0: Didn't implement anything <br> 2: Game loop ends properly when one player clears his hand <br> 4: Part of the game logic functions properly in a game loop <br> 6: Fully functioning game logic in a game loop|
